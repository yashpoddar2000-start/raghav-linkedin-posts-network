...
async function testSubwayResearch() {
  console.log('\n' + '██'.repeat(35));
  console.log('█ RESEARCH: Subway Store Closures & Market Leadership');
  console.log('██'.repeat(35));

  const topic = 'Subway closed 7,601 units but remains largest restaurant brand - how?';
